...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-pp-bg flex items-center justify-center p-4 relative overflow-hidden">
      <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-pp-orange/5 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute top-1/3 left-1/4 w-80 h-80 bg-pp-orange/4 rounded-full blur-3xl pointer-events-none" />
      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="text-gray-400 text-sm mt-1">Find your Valorant duo</p>
        </div>

        <div className="card p-8">
          <h2 className="font-display font-bold text-xl text-gray-900 mb-6 tracking-wide">CREATE ACCOUNT</h2>
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            ...
            <Link to="/login" className="text-pp-orange hover:text-pp-orange-dark transition-colors font-semibold">
              Sign in
            </Link>
          </p>
        </div>
