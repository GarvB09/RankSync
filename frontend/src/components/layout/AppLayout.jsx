  ...
  return (
    <div className="flex h-screen overflow-hidden bg-pp-bg">
      ...
      <aside className={`
        ...
        w-64 flex flex-col bg-white border-r border-pp-border
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Mobile topbar */}
        <header className="lg:hidden flex items-center justify-between px-4 py-3 bg-white border-b border-pp-border shadow-sm">
